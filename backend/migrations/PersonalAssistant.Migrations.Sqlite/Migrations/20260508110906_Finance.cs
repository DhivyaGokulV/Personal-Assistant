        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PaymentTypeId = table.Column<Guid>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Accounts_OwnerUserId_IsDeleted",
                table: "Accounts",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Budgets_OwnerUserId_From_To",
                table: "Budgets",
                columns: new[] { "OwnerUserId", "From", "To" });

            migrationBuilder.CreateIndex(
                name: "IX_Categories_OwnerUserId_IsDeleted",
                table: "Categories",
                columns: new[] { "OwnerUserId", "IsDeleted" });

            migrationBuilder.CreateIndex(
                name: "IX_PaymentTypes_OwnerUserId_IsDeleted",
                table: "PaymentTypes",
                columns: new[] { "OwnerUserId", "IsDeleted" });

            migrationBuilder.CreateIndex(
                name: "IX_Tags_OwnerUserId_IsDeleted",
                table: "Tags",
                columns: new[] { "OwnerUserId", "IsDeleted" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_OwnerUserId_AccountId_Date",
                table: "Transactions",
                columns: new[] { "OwnerUserId", "AccountId", "Date" });

            migrationBuilder.CreateIndex(
                name: "IX_Transactions_OwnerUserId_Date_IsDeleted",
                table: "Transactions",
