...
namespace PersonalAssistant.Migrations.Sqlite.Migrations
{
    ...
    [Migration("20260712020735_AssetPreciousMetalsPossessions")]
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    JewelleryItemId = table.Column<Guid>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BuyingDate = table.Column<DateOnly>(type: "TEXT", nullable: false),
                    BuyingPrice = table.Column<decimal>(type: "TEXT", precision: 18, scale: 4, nullable: false),
                    QuantityInGrams = table.Column<decimal>(type: "TEXT", precision: 18, scale: 4, nullable: false),
                    Status = table.Column<int>(type: "INTEGER", nullable: false),
                    SellingDate = table.Column<DateOnly>(type: "TEXT", nullable: true),
                    SellingPrice = table.Column<decimal>(type: "TEXT", precision: 18, scale: 4, nullable: true),
                    SellingNote = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    PersonalAssetItemId = table.Column<Guid>(type: "TEXT", nullable: false),
                    Action = table.Column<int>(type: "INTEGER", nullable: false),
                    OldValuesJson = table.Column<string>(type: "TEXT", maxLength: 12000, nullable: true),
                    NewValuesJson = table.Column<string>(type: "TEXT", maxLength: 12000, nullable: true),
                    ChangedFieldsJson = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    PreciousMetalId = table.Column<Guid>(type: "TEXT", nullable: false),
