...
public static class DependencyInjection
{
    public static IServiceCollection AddInfrastructure(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddScoped<IPreciousMetalService, PreciousMetalService>();
        services.AddScoped<IJewelleryService, JewelleryService>();
        services.AddScoped<IPersonalAssetService, PersonalAssetService>();
        services.AddScoped<ILiabilityAccountService, LiabilityAccountService>();
