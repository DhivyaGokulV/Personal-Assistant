...
public interface IDailyTaskService
{
    ...
    Task ReorderGroupsAsync(IReadOnlyList<ReorderDailyGroupRequest> req, CancellationToken ct);
    ...
    Task DeleteTaskAsync(Guid id, ConfirmDeleteTaskRequest req, CancellationToken ct);
    Task ReorderTasksAsync(IReadOnlyList<ReorderDailyTaskRequest> req, CancellationToken ct);
    ...
    Task<DailyConsolidatedReport> GetConsolidatedReportAsync(DateOnly from, DateOnly to, CancellationToken ct);
    Task<IReadOnlyList<TaskArchiveDto>> GetArchiveAsync(CancellationToken ct);
}
